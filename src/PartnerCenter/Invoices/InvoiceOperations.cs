...
namespace Microsoft.Store.PartnerCenter.Invoices
{
    ...
    internal class InvoiceOperations : BasePartnerComponent<string>, IInvoice
    {
        ...
        {
            return new InvoiceLineItemCollectionOperations(Partner, Context, billingProvider, invoiceLineItemType);
        }
        ...
        {
            return new ReconciliationLineItemCollectionOperations(Partner, Context, provider, invoiceLineItemType, currencyCode, period, size);
        }
